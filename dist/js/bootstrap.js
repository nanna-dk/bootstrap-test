 ...
 * ======================================================================== */
+function ($) {
  'use strict'; // Check if the page is responsive
...
function shareURL(dest) {
  ...
  if ($.inArray(param, media) !== -1) {
    ...
    var suffix = isLinkedin === true ? '&title=' + encodeURIComponent(docTitle) + '&summary=&source=' + encodeURI(source) : ''; // Open in a new window:
...
(function ($) {
  ...
  $('.panel-accordion').on('show.bs.collapse', toggleClass); // Truncate multiple lines of text in News in global menu
  ...
  makeGlobalMenuClickable(); // Show/hide scroller if it exists
